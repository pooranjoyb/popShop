...
function Home() {
  return (
    <>
        ...
        <div className="max-w-xl ">
          ...
          <div className="text-mynavy">
            ...
            <div className="mt-8 w-full flex flex-wrap gap-4 text-center">
              ...
              <Link to="/shop" className="btn w-1/3 bg-mygreen hover:bg-myyellow text-white">
                Explore
              </Link>
            </div>
          </div>
      ...
      {/* Section  */}
      <div id="about" className="mx-auto max-w-screen-xl my-20 flex justify-between items-center pb-12">
