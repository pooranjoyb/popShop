        ...
        <div className="mx-auto max-w-screen-xl mb-20 flex px-4 pt-8 sm:pt-8 pb-4 ">
            <div className="">
                <div className="">
                    <div className="">
                        <div className="">
                            <h2 className="text-5xl my-3" id="terms">
                                <strong>Terms and Conditions</strong>
                            </h2>
                            <p className="mb-3">Welcome to Pop Shop!</p>
                            <p className="mb-3">
                                These terms and conditions outline the rules and
                                regulations for the use of Pop Shop's Website,
                                located at pop-shop-github.vercel.app.
                            </p>
                            <p className="mb-3">
                                By accessing this website we assume you accept
                                these terms and conditions. Do not continue to
                                use Pop Shop if you do not agree to take all of
                            ...
                            <p className="mb-3">
                                ...
                                and subject to, prevailing law of in. Any use of
                            ...
                            <h3 className="mt-10 text-3xl my-3" id="cookies">
                                <strong>Cookies</strong>
                            </h3>
                            <p className="mb-3">
                                We employ the use of cookies. By accessing Pop
                                Shop, you agreed to use cookies in agreement
                                with the Pop Shop's Privacy Policy.{" "}
                            </p>
                            <p className="mb-3">
                            ...
                            <h3 className="mt-10 text-3xl my-3" id="license">
                                <strong>License</strong>
                            </h3>
                            <p className="mb-3">
                                Unless otherwise stated, Pop Shop and/or its
                                licensors own the intellectual property rights
                                for all material on Pop Shop. All intellectual
                                property rights are reserved. You may access
                                this from Pop Shop for your own personal use
                                subjected to restrictions set in these terms and
                                conditions.
                            </p>
                            <p className="mb-3">You must not:</p>
                            <ul>
                                <li>Republish material from Pop Shop</li>
                                <li>
                                    Sell, rent or sub-license material from Pop
                                    Shop
                                </li>
                                <li>
                                ...
                                <li>Redistribute content from Pop Shop</li>
                            </ul>
                            <p className="mb-3">
                            ...
                            <p className="mb-3">
                                ...
                                information in certain areas of the website. Pop
                                Shop does not filter, edit, publish or review
                                Comments prior to their presence on the website.
                                Comments do not reflect the views and opinions
                                of Pop Shop,its agents and/or affiliates.
                                Comments reflect the views and opinions of the
                                person who post their views and opinions. To the
                                extent permitted by applicable laws, Pop Shop
                                shall not be liable for the Comments or for any
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    shopping malls, and charity fundraising
                                    groups which may not hyperlink to our Web
                                    site.
                                </li>
                            </ul>
                            <p className="mb-3">
                            ...
                            <p className="mb-3">
                                ...
                                absence of Pop Shop; and (d) the link is in the
                            ...
                            <p className="mb-3">
                                ...
                                e-mail to Pop Shop. Please include your name,
                                your organization name, contact information as
                                well as the URL of your site, a list of any URLs
                                from which you intend to link to our Website,
                                and a list of the URLs on our site to which you
                                would like to link. Wait 2-3 weeks for a
                                response.
                            </p>
                            <p className="mb-3">
                            ...
                            <p className="mb-3">
                                No use of Pop Shop's logo or other artwork will
                                be allowed for linking absent a trademark
                                license agreement.
                            </p>
                            <h3 className="mt-10 text-3xl my-3" id="iframes">
                            ...
                            <h3 className="mt-10 text-3xl my-3" id="liability">
                            ...
                            <h3 className="mt-10 text-3xl my-3" id="rights">
                            ...
                            <h3 className="mt-10 text-3xl my-3" id="links">
                                <strong>
                            ...
                            <h3 className="mt-10 text-3xl my-3" id="disclaimer">
