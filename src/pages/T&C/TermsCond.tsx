            ...
            <div className="">
              <div className="">
                ...
                <p className="mb-3">
                  ...
                  for the use of Pop Shop's Website, located at
                  pop-shop-github.vercel.app.
                </p>
                <p className="mb-3">
                ...
                <ul>
                  ...
                  <li>Sell, rent or sub-license material from Pop Shop</li>
                  <li>Reproduce, duplicate or copy material from Pop Shop</li>
                ...
                <p className="mb-3">
                  ...
                  compensates the absence of Pop Shop; and (d) the link is in
                ...
                <p className="mb-3">
                  ...
                  inform us by sending an e-mail to Pop Shop. Please include
                ...
                <p className="mb-3">
                  No use of Pop Shop's logo or other artwork will be allowed for
