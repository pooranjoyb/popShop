...
function Shop() {
    ...
    const filter = [
        ...
        checkbox: ["below-₹1000", "₹1000-₹2000", "₹2000-₹4000", "₹4000-₹8000", "₹8000-and above"]
        },
    ]
        ...
        <>
            <div className=" mx-auto max-w-screen-xl px-4 py-12 flex justify-between items-center">
                ...
                {/* The button to open modal */}
                    <label htmlFor="my_modal_6" className="btn bg-mygreen hover:bg-myyellow">Filters</label>
                    {/* Modal Body*/}
                    <input type="checkbox" id="my_modal_6" className="modal-toggle w-5xl" />
                    <div className="modal" role="dialog">
                        <div className="modal-box w-[30rem]">
                            ...
                            <div className="flex font-semiold justify-around mt-5">
                                {filter.map((fil,idx) => 
                                    <div key={idx}>
                                        ...
                                        {fil.checkbox.map((size,index) => {return (
                            ...
                            <div className="modal-action justify-center pe-5">
                                <label htmlFor="my_modal_6" className="btn hover:bg-mygreen bg-myyellow">Apply</label>
                            </div>
                        </div>
                    </div>
                
                    <label className="input input-bordered input-success flex items-center gap-2 w-64">
